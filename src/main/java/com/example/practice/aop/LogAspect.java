...
public class LogAspect {
    ...
    // 配置织入点 ,通过自定义注解
    @Pointcut("@annotation(com.example.practice.aop.Log)")
    public void logPointCut() {
    }

    // 配置织入点，通过执行包的方法
    @Pointcut("execution(* com.example.practice.aop.controller..*.*(..))")
     ...
     * @param joinPoint 切点
     */
    @AfterReturning(pointcut = "logPointCut1()", returning = "jsonResult")
